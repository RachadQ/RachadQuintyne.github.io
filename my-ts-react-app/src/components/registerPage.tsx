            ...
            <div className="relative bg-white rounded-lg shadow w-1/2 mx-auto mt-12">
                <div className="p-5">
                    <div className="text-center">
                        <p className="mb-3 text-2xl font-semibold leading-5 text-gray-900">Create an account</p>
                        <p className="mt-2 text-sm leading-4 text-gray-600">Start your journey with us.</p>
                    </div>
                    ...
                    <form className="mt-6 space-y-4">
                        <div>
                            ...
                            <input type="text" id="name" autoComplete="name" required className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:ring-gray-300 focus:border-gray-300" placeholder="Full Name" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="password" id="password" autoComplete="new-password" required className="block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:ring-gray-300 focus:border-gray-300" placeholder="Password" />
                        </div>
